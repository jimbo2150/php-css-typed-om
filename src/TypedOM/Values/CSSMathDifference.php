...
/**
 * A CSSMathDifference is a CSSNumericValue that is the result of a subtraction.
 * It is used to represent `calc()` expressions with subtraction.
 *
 * @see https://developer.mozilla.org/en-US/docs/Web/API/CSSMathDifference
 */
